...
public class TravelPlanner {
    ...
    public static long calculateTripDuration(LocalDate departureDate, LocalDate returnDate) {
        // Step 2: Calculate and return the number of days between departure and return
        // dates
    ...
    public static boolean validateTravelDates(LocalDate departureDate, LocalDate returnDate) {
        ...
        long duration = ChronoUnit.DAYS.between(departureDate, returnDate);

        if (duration > 90) {
            System.out.println("Trip duration should not exceed 90 days!");
            return false;
        }
    ...
    public static void main(String[] args) {
        ...
        // Step 8: Display appropriate messages to the user based on the operations
        // performed
